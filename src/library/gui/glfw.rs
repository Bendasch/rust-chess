...
extern "C" {
    ...
    pub fn glfwSetMouseButtonCallback(
        ...
        callback: unsafe extern "C" fn(*const GLFWwindow, c_int, c_int, c_int),
    );
    ...
    pub fn glfwSetWindowSizeCallback(
        window: *const GLFWwindow,
        callback: extern "C" fn(*const GLFWwindow, c_int, c_int),
    );
    pub fn glfwSetFramebufferSizeCallback(
        window: *const GLFWwindow,
        framebuffer_size_callback: extern "C" fn(*const GLFWwindow, c_int, c_int),
    );
}
